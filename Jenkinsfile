		...
		stage('Deploy to OpenShift') {
			steps {
				sh '''
                    ...
                    /opt/homebrew/bin/oc set image deployment/myapp myapp=$DOCKER_USER/hello-world-0.0.1-snapshot:${BUILD_NUMBER}
					/opt/homebrew/bin/oc rollout status deployment/myapp
                '''
			}
		}

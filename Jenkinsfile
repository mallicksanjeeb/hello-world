			...
			steps {
				withCredentials([usernamePassword(credentialsId: 'docker-hub',
					...
					sh '''
                        ...
                        /usr/local/bin/docker build -t $DOCKER_USER/hello-world .
                        /usr/local/bin/docker push $DOCKER_USER/hello-world
                    '''
				}
			}
		}
		...
		stage('Deploy to OpenShift') {
			steps {
				sh '''
                    ...
                    /opt/homebrew/bin/oc set image deployment/hello-world hello-world-container=$DOCKER_USER/hello-world
